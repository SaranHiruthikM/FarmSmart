      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12">
        <div>
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-black text-gray-900 tracking-tight">{t('nav.notifications')}</h1>
          </div>
          <p className="text-gray-500 text-lg font-medium ml-2">{t('notifications.subtitle')}</p>
        </div>
