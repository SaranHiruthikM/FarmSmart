...
const OrderHistory = () => {
    ...
    const filteredOrders = orders.filter((order) => {
        ...
        const matchesFilter = filterStatus === "ALL" || order.status?.toUpperCase() === filterStatus;
    ...
    const statuses = ["ALL", "CREATED", "CONFIRMED", "SHIPPED", "DELIVERED", "COMPLETED"];
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className={`p-3.5 bg-white border-2 rounded-2xl transition-all ${filterStatus !== "ALL" || isFilterOpen ? "border-primary text-primary" : "border-neutral-light text-secondary hover:border-primary/50 hover:text-primary"}`}
                        >
                        ...
                        {isFilterOpen && (
                            <>
                                ...
                                />
                                <div className="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border-2 border-neutral-light overflow-hidden z-20 animate-in zoom-in-95 duration-200">
                                    <div className="p-2">
                                        {statuses.map((status) => (
                                            <button
                                                key={status}
                                                ...
                                                className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-bold transition-colors ${filterStatus === status ? "bg-primary/10 text-primary" : "text-secondary hover:bg-neutral-light"}`}
                                            >
                                                {status}
                                            </button>
                                        ))}
            ...
            <div className="grid gap-4">
                {loading ? (
                    <div className="text-center py-20">
                        ...
                        <p className="text-accent font-medium">Loading orders...</p>
                    </div>
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border border-neutral-light/50">
                        ...
                        <p className="text-accent mt-2 max-w-md mx-auto">
