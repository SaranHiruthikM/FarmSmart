...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { label: t('nav.reviews'), icon: Star, path: "/dashboard/reviews", roles: ["farmer", "buyer"] },
        { label: t('nav.disputes'), icon: ShieldAlert, path: "/dashboard/disputes", roles: ["farmer", "buyer"] },
