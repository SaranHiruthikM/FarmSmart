...
exports._test = exports.getMockComparePrices = exports.getMockPriceHistory = exports.getMockCurrentPrices = void 0;
const seedFromStrings = (...parts) => {
    const s = parts
        .filter(Boolean)
...
const getMockCurrentPrices = (crop) => {
...
exports.getMockCurrentPrices = getMockCurrentPrices;
const getMockPriceHistory = (crop, location) => {
...
exports.getMockPriceHistory = getMockPriceHistory;
const getMockComparePrices = (crop, location) => {
    const seed = seedFromStrings(crop, location);
    const base = 18 + Math.round(pseudoRand(seed) * 20);
    const mandis = ['Local Mandi', 'District Hub', 'Wholesale Yard', 'Agri Market', 'City Mandi'].map((name, idx) => {
...
exports.getMockComparePrices = getMockComparePrices;
exports._test = {
    seedFromStrings,
    pseudoRand,
    clamp,
};
//# sourceMappingURL=priceMocks.js.map